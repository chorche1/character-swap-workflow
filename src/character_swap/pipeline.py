...
GENERATION_PROMPT = (
    ...
    "Let the environment ACT ON the person: wrap a subtle rim / edge light from "
    "the background around their silhouette, and bounce nearby surface colors "
    "onto their skin and clothing (color spill). "
    "Use organic, realistic lighting and make EVERYTHING look like the same "
    "scene — one photograph taken in one place — not like the person was pasted "
    "onto the background. Never a collage.\n\n"
    ...
    "an edge with no rim-light wrap, a subject untouched by the scene's bounce "
    "light, artificial-looking lighting instead of organic, the person looking "
    "like a different scene than the background, "
