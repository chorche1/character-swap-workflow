...
GENERATION_PROMPT = (
    ...
    "the background around their silhouette, bounce nearby surface colors onto "
    "their skin and clothing (color spill), and match the scene's overall "
    "exposure so they are neither brighter nor darker than it. Render them as if "
    "captured by the SAME camera and lens as the scene — same focal length, "
    ...
    "light or grain, a cleaner sensor signature than the background, "
