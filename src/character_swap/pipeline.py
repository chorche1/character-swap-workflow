...
GENERATION_PROMPT = (
    ...
    "realistic integrated lighting, sharp focus, no blurry background. Zero "
    "burnt-in text or watermarks.\n\n"
    "AVOID: identity bleed from the original person, extra or distorted "
    "fingers, warped faces, changed or restyled background, altered prop "
    "counts, props changing state, misspelled labels, captions, subtitles, "
    "watermarks, cartoon or illustration look."
)
