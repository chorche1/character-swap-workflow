...
GENERATION_PROMPT = (
    ...
    "processing, enhanced clarity, and polished skin. Use the scene's own "
    "mundane everyday light exactly as it appears there (window daylight, "
    "indoor lamps, or a dim evening mix) with slightly uneven exposure, mild softness, subtle sensor "
