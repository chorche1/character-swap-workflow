...
GENERATION_PROMPT = (
    ...
    "Transfer only the replacement person’s face, hairstyle, skin tone, "
    "clothing, accessories, and gloves from Image 2. The replacement person "
    ...
    "Use realistic organic lighting, natural shadows, accurate anatomy, "
    "realistic skin texture, realistic fabric detail, and documentary-style "
    "photographic sharpness. Keep the entire image in focus with no background "
    "blur, no shallow depth of field, and no portrait-mode effect. Remove all "
    "text overlays, captions, subtitles, logos, watermarks, and graphic "
    "elements. Keep the final image realistic, non-explicit, and non-NSFW.\n"
    "Negative prompt:\n"
    ...
    "replacement from Image 2, no blurred background, no shallow depth of "
    "field, no text, no captions, no subtitles, no watermark, no logos, no "
    "altered table placement, no moved objects, no missing objects, no "
    "duplicated objects, no changed hand placement, no changed pose, no averted "
